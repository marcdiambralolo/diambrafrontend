...
import { Activity, AlertCircle, BarChart3, Clock, CreditCard, DollarSign, FileText, LucideIcon, RefreshCw, Sparkles, TrendingDown, TrendingUp, Users } from 'lucide-react';
