...
export const SuccessState = () => (
  ...
  >
    ...
    <motion.p initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }} className="text-slate-600 text-sm sm:text-base">À bientôt sur Diambra ✨</motion.p>
