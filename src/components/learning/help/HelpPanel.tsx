        ...
        <div className={`w-full max-w-md mx-auto mt-2 mb-4 transition-all duration-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="relative h-20 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600">
                    <button
                        onClick={onClose}
                        className="absolute top-2 right-2 w-7 h-7 bg-white/20 backdrop-blur rounded-full flex items-center justify-center hover:bg-white/30 transition-colors"
                        aria-label="Fermer"
                    >
                ...
                <div className="p-3 max-h-[70vh] overflow-y-auto">
                    <button
                        onClick={onClose}
                        className="w-full mb-3 py-2 bg-purple-50 rounded-xl text-purple-700 text-xs font-semibold flex items-center justify-center gap-2 hover:bg-purple-100 transition-colors"
                    >
