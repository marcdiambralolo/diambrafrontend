...
import {
  Activity, ArrowLeft, BarChart3, ChevronLeft, ChevronRight, Clock, Crown,
  FileText, Flame, Hash, LayoutGrid, Medal, RefreshCw,
  Sparkles, Star, Target, TrendingUp, Trophy, Users,
} from 'lucide-react';
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 flex items-center gap-2">
                ...
                {stats.totalGames} jeu{stats.totalGames > 1 ? 'x' : ''} enregistré{stats.totalGames > 1 ? 's' : ''} actuellement
              </p>
            </div>
            ...
            <div className="flex items-center gap-3">
              <div className="flex gap-1 p-1 bg-gray-100 dark:bg-gray-800 rounded-xl">
                <button
                  ...
                  className={`p-2 rounded-lg transition-all ${viewMode === 'grid' ? 'bg-white dark:bg-gray-700 shadow-md text-purple-600' : 'text-gray-500'}`}
                >
