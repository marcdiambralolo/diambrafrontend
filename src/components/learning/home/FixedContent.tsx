...
import { COLORS, NO_DATA_PLACEHOLDER } from "@/lib/learning/constantes";
import { formatDuration } from "@/lib/learning/functions";
import { useMonEtoileStore } from "@/lib/store/monetoile.store";
import { Calendar, CheckCircle, ChevronDown, Loader2, Send, Trophy, Users } from "lucide-react";
...
const FeuilleDeMatch = memo(() => {
    ...
    const hasValidatedGame = competitionList?.some(c => c.isValidated);
