...
import { APP_NAME, CURRENT_YEAR, MESSAGE_DURATION, NO_DATA_PLACEHOLDER, STATUS_CONFIG } from "@/lib/learning/constantes";
import { formatDuration } from "@/lib/learning/functions";
import { useMonEtoileStore } from "@/lib/store/monetoile.store";
import { HelpCircle, Loader2, Medal, RotateCcw, Send, Trophy } from "lucide-react";
